...
<html>
    ...
    <%
         ...
         DBManager manager = (DBManager)session.getAttribute("manager");
           ArrayList<Time> AllTime = manager.getAllTime();;
    ...
    <form action="accessManagement.jsp" method = POS>
        <table  id ="t01" >
            ...
            <tr>
             ...
             <td width="30%"><%=t.getCustomerID()%>q</td> 
             <td width="30%"><%=/*/(java.util.Date)*/t.getLoginT()%>q</td>
             <td width="30%"><%=t.getLogoutT()%>q</td>     
       ...
       <% //if(request.getParameter("Delete")!=null)
            // {
                 //manager.deleteRecord(ID,t.getLoginT());
